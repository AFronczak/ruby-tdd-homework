...
class RomanTest < MiniTest::Test
  ...
  def test_double_digit_numbers
    # test so that 11 gives XI....etc
    assert_equal "XIII",  Roman.new.numerals(13)
    assert_equal "XIV",   Roman.new.numerals(14)
    assert_equal "XV",    Roman.new.numerals(15)
    assert_equal "XVIII", Roman.new.numerals(18)
    assert_equal "XIV",   Roman.new.numerals(19)
  end
end
